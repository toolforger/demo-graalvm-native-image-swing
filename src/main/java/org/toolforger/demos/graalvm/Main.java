...
public class Main extends JFrame {
  ...
  public Main() {
    super("Cat Facts");
    var table = new JTable(new CatFactTableModel());
  ...
  static class CatFactTableModel extends AbstractTableModel {
        public CatFactTableModel() {}

    @Override
    public int getRowCount() {
      return catfacts.length;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
      return switch (columnIndex) {
        case 0 -> rowIndex + 1;
        case 1 -> catfacts[rowIndex];
        default -> null;
      };
    }
  }

  static String[] catfacts = {
    ...
    "The group of words associated with cat (catt,\u00a0cath,\u00a0chat,\u00a0katze) stem from the Latin\u00a0catus, meaning domestic cat, as opposed to\u00a0felis, or wild cat.",
    ...
    "The first cartoon cat was\u00a0Felix the Cat\u00a0in 1919. In 1940, Tom and Jerry starred in the first theatrical cartoon \u201cPuss Gets the Boot.\u201d In 1981 Andrew Lloyd Webber created the musical \"Cats\", based on T.S. Eliot\u2019s \"Old\u00a0Possum\u2019s Book of Practical Cats\".",
    ...
    "A cat can independently rotate its ears 180 degrees.",
    ...
    "The largest cat breed is the Ragdoll. Male Ragdolls weigh between 12 and 20 lbs (5.4-9.0kg). Females weigh between 10 and 15 lbs (4.5-6.8kg).",
    ...
    "The largest breed of cat is the Ragdoll with males weighing in at 15 to 20 lbs. The heaviest domestic cat on record was a neutered male tabby named Himmy from Queensland, Australia who weighed 46 lbs. 15 oz.",
